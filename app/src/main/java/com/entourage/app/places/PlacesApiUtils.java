...
{
    private static final String LOG_TAG = "ENTOURAGE [PlacesApiUtils]";
    ...
    public static ArrayList<String> search(String input) {
        ...
        try {
            ...
            sb.append("&location=45.7550680,4.8332977");
            sb.append("&rankby=distance");
            sb.append("&types=bar|night_club|establishment");
